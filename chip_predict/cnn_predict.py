...
def main(default_model_glob: Optional[str] = None,
    ...
    260506 — pseudo-label feature REMOVED per user directive (was copying inputs into
    classification_chips/<pred_class>/_PSEUDO.png, contaminating defect class folders
    with normal-looking chips).
    """
    ...
    # 260506 — pseudo-label CLI args REMOVED (was contaminating defect folders).
    args = ap.parse_args()
    ...
    # 260506 — pseudo-label feature REMOVED per user directive.
    ...
    if csv_path is not None:
        ...
        with csv_path.open("w", encoding="utf-8", newline="") as f:
            ...
            cols += ["pred_class", "pred_idx", "max_prob", "is_normal"]
            if has_labels:
