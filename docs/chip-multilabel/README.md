...
- [iters/iter_06_phase_a3_epochs_sweep.md](iters/iter_06_phase_a3_epochs_sweep.md) — Phase A3 epochs sweep + Phase A close-out
- [iters/iter_07_phase_f_warmup_ema_t7_cutmix.md](iters/iter_07_phase_f_warmup_ema_t7_cutmix.md) — Phase F warmup/EMA negative + T7 BCE/CutMix peak (★)
...
|    6 | (no new best)  |     0.9268 |     0.8449 |            +0.0000 | outputs/phase_a_260505_185805 — Phase A3 confirms ep=8 is global best          |
|    7 | **T7c__I10**   | **0.9271** |     0.8307 |        **+0.0003** | outputs/stage1_260505_195730 — BCE+LS=0.20+CutMix(p=0.5); bb+sr 0.32→0.96      |

Argmax baseline (I0): macro_f1 = 0.7302, top1\_11 = 0.4472. **Iter 7 ties Phase A on macro-F1 (T7c = 0.9271 vs T1_LS20 = 0.9268) but flips the operational profile**: bb+sr combo recall 0.32 → 0.96, scratch_rot F1 → 1.0000, ECE_post 4× lower. Cumulative gain over baseline: **+0.1969 macro-F1 / +0.3835 top1\_11** (T7c__I10) — top1_11 best still owned by T1_LS20__I7 (+0.3977).
